...
author: "Işıkay Karakuş, 2071938, Onur Alp Güvercin, 2072249, Su Doğan, 2071957"
date: "July 17, 2023"
output:
...
-  Condition2 represents the proximity of the houses to various
   conditions when more than one condition is present.'Norm' has a        higher frequency compared to the other conditions, resulting in an     imbalanced distribution.
...
- Street represents the type of road access to the properties. The bar
  ...
  two categories, highlighting the dominance of paved road access in     the dataset.
